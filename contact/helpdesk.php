...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($nameErr) && empty($emailErr) && empty($messageErr)){
        ...
        // this should be <username>@<username>.gc-webhosting.nl user is in this case xjansen
        $to = 'xjansen@xjansen.gc-webhosting.nl';
...
<body>
    <div class="wrapper">
        ...
        <p>Please fill in this form with your question and send us.</p>
        <form action="helpdesk.php" method="post">
            ...
            <div class="form-group">
                <label for="inputComment">Message/problem<sup>*</sup></label>
